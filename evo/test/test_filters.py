...
class TestFilterPairsByPath(unittest.TestCase):
    def test_poses1_all_pairs(self):
        target_path = 1.0
        tol = 0.0
        id_pairs = filters.filter_pairs_by_path(poses_1, target_path, tol, all_pairs=True)
    ...
    def test_poses2_all_pairs_low_tolerance(self):
        target_path = 1.0
        tol = 0.001
        id_pairs = filters.filter_pairs_by_path(poses_2, target_path, tol, all_pairs=True)
        self.assertEqual(id_pairs, [(0, 3)])

    def test_convergence_all_pairs(self):
        target_path = 1.0
        tol = 0.2
        id_pairs = filters.filter_pairs_by_path(poses_3, target_path, tol, all_pairs=True)
...
class TestFilterPairsByDistance(unittest.TestCase):
    def test_poses1_all_pairs(self):
        target_path = 1.0
        tol = 0.0
        id_pairs = filters.filter_pairs_by_distance(poses_1, target_path, tol, all_pairs=True)
    ...
    def test_poses2_all_pairs_low_tolerance(self):
        target_path = 1.0
        tol = 0.001
        id_pairs = filters.filter_pairs_by_distance(poses_2, target_path, tol, all_pairs=True)
        self.assertEqual(id_pairs, [(0, 3)])

    def test_poses4_all_pairs(self):
        target_path = 1.0
        tol = 0.2
        id_pairs = filters.filter_pairs_by_distance(poses_4, target_path, tol, all_pairs=True)
...
class TestFilterPairsByAngle(unittest.TestCase):
    def test_poses5(self):
        ...
        tol = 0.001
        id_pairs = filters.filter_pairs_by_angle(poses_5, target_angle, tol, all_pairs=False)
        self.assertEqual(id_pairs, [(0, 1), (1, 2), (2, 4)])

    def test_poses5_all_pairs(self):
        target_angle = math.pi
        tol = 0.01
        id_pairs = filters.filter_pairs_by_angle(poses_5, target_angle, tol, all_pairs=True)
        self.assertEqual(id_pairs, [(0, 1), (0, 4), (1, 2), (2, 4)])

    def test_poses6(self):
        target_angle = math.pi
        tol = 0.001
        id_pairs = filters.filter_pairs_by_angle(poses_6, target_angle, tol, all_pairs=False)
        self.assertEqual(id_pairs, [(0, 3)])

    def test_poses6_all_pairs(self):
        target_angle = math.pi
        tol = 0.001
        id_pairs = filters.filter_pairs_by_angle(poses_6, target_angle, tol, all_pairs=True)
...
class TestFilterPosesBySpeed(unittest.TestCase):
    def test_poses_7_stamps_7(self):
        ...
        tol = 0.01
        id_pairs = filters.filter_pairs_by_speed(poses_7, stamps_7, target_speed, tol)
        self.assertEqual(id_pairs, [(0, 1), (1, 2), (2, 3)])

    def test_poses_8_stamps_8(self):
        target_speed = 1.0  # m/s
        tol = 0.01
        id_pairs = filters.filter_pairs_by_speed(poses_8, stamps_8, target_speed, tol)
...
class TestFilterPosesByAngularSpeed(unittest.TestCase):
    def test_poses_7_stamps_7_radians(self):
        ...
        tol = 0.01
        id_pairs = filters.filter_pairs_by_angular_speed(poses_7, stamps_7, target_speed, tol)
        self.assertEqual(id_pairs, [])

    def test_poses_6_stamps_6_radians(self):
        target_speed = math.pi/3  # rad/s
        tol = 0.01
        id_pairs = filters.filter_pairs_by_angular_speed(poses_6, stamps_6, target_speed, tol)
        self.assertEqual(id_pairs, [(0, 1), (1, 2), (2, 3)])
    ...
    def test_poses_7_stamps_7_degrees(self):
        ...
        tol = 0.01
        id_pairs = filters.filter_pairs_by_angular_speed(poses_7, stamps_7, target_speed, tol, degrees=True)
        self.assertEqual(id_pairs, [])

    def test_poses_6_stamps_6_degrees(self):
        target_speed = math.pi/3.0 * 180/math.pi  # rad/s
        tol = 0.01
        id_pairs = filters.filter_pairs_by_angular_speed(poses_6, stamps_6, target_speed, tol, degrees=True)
        self.assertEqual(id_pairs, [(0, 1), (1, 2), (2, 3)])
